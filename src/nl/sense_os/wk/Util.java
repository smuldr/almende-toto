...
public class Util {
    ...
    public static int getJokers(Context context, String username) {
        ...
        // get available jokers and the predictions (including any jokers already used)
        String poulesPred = "", finals8Pred = "", finals4Pred = "", finals2Pred = "", finals1Pred = "";
        String poulesReal = "", finals8Real = "", finals4Real = "", finals2Real = "", finals1Real = "";
        try {
            ...
            finals8Pred = predScores.getString("finals8");
            ...
            finals8Real = realScores.getString("finals8");
        ...
        final ArrayList<Game> finals8 = Util.csvToGames(finals8Pred, finals8Real);
        for (Game game : finals8) {
            if (game.joker) {
                availableJokers--;
            }
        }
    ...
    public static ArrayList<Round> getFinals(Context context, String username) { 
        ...
        // get the predictions and real scores
        String finals8Pred = "", finals4Pred = "", finals2Pred = "", finals1Pred = "";
        String finals8Real = "", finals4Real = "", finals2Real = "", finals1Real = "";
        try {
            JSONObject scores = new JSONObject(jsonScores);
            JSONObject scoresList = scores.getJSONObject("list");
        ...
        // put scores in the games
        final ArrayList<Game> finals8Games = Util.csvToGames(finals8Pred, finals8Real);
        final Round finals8NoScores = finals.get(0);
        for (int i = 0; i < finals8NoScores.games.size(); i++) {
            Game noTeams = finals8Games.get(i);
            Game noScores = finals8NoScores.games.get(i);
            ...
            finals8NoScores.games.set(i, noScores);
        }
        finals.set(0, finals8NoScores);

        final ArrayList<Game> finals4Games = Util.csvToGames(finals4Pred, finals4Real);
        final Round finals4NoScores = finals.get(1);
